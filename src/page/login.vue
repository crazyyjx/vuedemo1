    ...
    <div class="login-page-container">
      ...
      >
        ...
        <el-form-item prop="account">
          <el-input type="text" v-model="ruleForm2.account" placeholder="输入as"></el-input>
        </el-form-item>
        <el-form-item prop="checkPass">
          <el-input type="password" v-model="ruleForm2.checkPass" placeholder="输入ry"></el-input>
        </el-form-item>
      ...
      this.$refs.ruleForm2.validate(valid => {
        if (valid) {
          ...
          setTimeout(() => {
            ...
            this.logining = false;
            this.$router.push({ path: "/menu1" });  // 去主页
          }, 1000);
          // const params = {
          //   userName: this.ruleForm2.account,
          //   password: this.ruleForm2.checkPass
